...
module TicTacToe
  describe Game do
    ...
    let(:frank) { Player.new({ color: "X", name: "frank"})}
    ...
    context "#initialize" do 
      #it "randomly selects a current_player" do
       ...
       # expect(game.current_player).to eq(frank||bob)
      #end
    ...
    context "#solicit_move" do
      it "asks the player to make a move" do
        ...
        expect(game.solicit_move).to eq("bob: Enter a number between 1 and 9 to make your move.")
      end
    end
